...
# TODO: retrain binned with balanced dataset
# TODO: add the second conv block into network (continunet code error needs fixing)
...
class CustomCallBack(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        np.save(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_5x5_rebinned.npy", self.logs_losses)
        ...
        plt.savefig(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_plot_5x5_rebinned.png")

        ax.set_yscale("log")
        plt.savefig(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_plot_5x5_rebinned_log.png")
...
callbacks = [
    ...
    ModelCheckpoint(
        "unet/trained_model_5x5_rebinned.h5",
        verbose=1,
        save_best_only=True,
...
plt.savefig("unet/loss_plot_5x5_rebinned.png")

ax.set_yscale("log")
plt.savefig("unet/loss_plot_5x5_rebinned_log.png")
plt.close()
