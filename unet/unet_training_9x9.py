...
class Unet:
    ...
    def encoding_block(self, input_tensor, filters, kernel_size=9):
    ...
    def decoding_block(self, input_tensor, concat_tensor, filters, kernel_size=9):
...
unet_model = Unet(input_shape=(256, 2048, 1), output_activation=None, layers=4)
...
class CustomCallBack(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        np.save(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_9x9.npy", self.logs_losses)
        ...
        plt.savefig(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_plot_9x9.png")
        plt.close()
...
plt.savefig("unet/loss_plot_9x9.png")
