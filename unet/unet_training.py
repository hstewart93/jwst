...
class CustomCallBack(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        np.save(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss.npy", self.logs_losses)
        ...
        plt.savefig(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_plot.png")
        plt.close()
...
plt.savefig("unet/loss_plot.png")
