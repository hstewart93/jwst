...
class Unet:
    ...
    def convolutional_block(self, input_tensor, filters):
    ...
    def encoding_block(self, input_tensor, filters):
        """Encoding block for UNet."""
        convolutional_block = self.convolutional_block(input_tensor, filters)
    ...
    def decoding_block(self, input_tensor, concat_tensor, filters):
        ...
        dropout_layer = Dropout(self.dropout)
        return self.convolutional_block(dropout_layer(skip_connection), filters)
...
unet_model = Unet(input_shape=(256, 2048, 1), output_activation=None, layers=6, kernel_size=(5, 41))
...
class CustomCallBack(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        np.save(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_5x41.npy", self.logs_losses)
        ...
        plt.savefig(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_plot_5x41.png")

        ax.set_yscale("log")
        plt.savefig(f"{os.environ['HOME']}/Code/ExoTiC-NEAT-training/unet/training_loss_plot_5x41_log.png")
...
plt.savefig("unet/loss_plot_5x41.png")

ax.set_yscale("log")
plt.savefig("unet/loss_plot_5x41_log.png")
plt.close()
